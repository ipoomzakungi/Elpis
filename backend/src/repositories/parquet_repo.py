...
class ParquetRepository:
    ...
    def save_ohlcv(self, data: pl.DataFrame, symbol: str = "BTCUSDT", interval: str = "15m") -> Path:
    ...
    def save_open_interest(self, data: pl.DataFrame, symbol: str = "BTCUSDT", interval: str = "15m") -> Path:
    ...
    def save_funding_rate(self, data: pl.DataFrame, symbol: str = "BTCUSDT", interval: str = "15m") -> Path:
    ...
    def save_features(self, data: pl.DataFrame, symbol: str = "BTCUSDT", interval: str = "15m") -> Path:
    ...
    def load_open_interest(self, symbol: str = "BTCUSDT", interval: str = "15m") -> Optional[pl.DataFrame]:
    ...
    def load_funding_rate(self, symbol: str = "BTCUSDT", interval: str = "15m") -> Optional[pl.DataFrame]:
    ...
    def load_features(self, symbol: str = "BTCUSDT", interval: str = "15m") -> Optional[pl.DataFrame]:
    ...
    def get_data_quality(self, data: pl.DataFrame, data_type: str) -> dict:
        ...
        if len(data) > 1:
            ...
            expected_diff = pl.duration(minutes=15)
